    ...
    DataDownload = (function() {
        function InstructorDashboardDataDownload($section) {
            ...
            this.$proctored_exam_csv_btn.click(function() {
                ...
                var error_message = gettext('Error generating proctored exam results. Please try again.');
                return $.ajax({
                    type: 'POST',
                    dataType: 'json',
                    url: url,
            ...
            this.$survey_results_csv_btn.click(function() {
                ...
                var error_message = gettext('Error generating survey results. Please try again.');
                return $.ajax({
                    type: 'POST',
                    dataType: 'json',
                    url: url,
            ...
            this.$list_studs_csv_btn.click(function() {
                ...
                var error_message = gettext('Error generating student profile information. Please try again.');
                dataDownloadObj.clear_display();
                return $.ajax({
                    type: 'POST',
                    dataType: 'json',
            ...
            this.$list_may_enroll_csv_btn.click(function() {
                ...
                var error_message = gettext('Error generating list of students who may enroll. Please try again.');
                dataDownloadObj.clear_display();
                return $.ajax({
                    type: 'POST',
                    dataType: 'json',
