...
def award_program_certificates(self, username, site_id):
    """
    ...
    Args:
        ...
        site_id (int): ID of the Site for which data should be retrieved.
    ...
    try:
        ...
        program_uuids = get_completed_programs(site, student)
